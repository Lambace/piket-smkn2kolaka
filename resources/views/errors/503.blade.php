...
<body class="min-h-screen flex items-center justify-center p-4">
    ...
    <div class="glass-card max-w-lg w-full p-8 text-center">
        ...
        <div class="border-t pt-6">
            ...
            <a href="https://wa.me/6282195914315" target="_blank" class="inline-flex items-center px-4 py-2 bg-green-500 hover:bg-green-600 text-white font-medium rounded-lg transition duration-200">
